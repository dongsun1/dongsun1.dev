    ...
    <Container title="dongsun1 resume" desc="프론트엔드 개발자 김동선 Resume입니다.">
      <div className="container mx-auto max-w-3xl px-4 lg:px-0">
        ...
        <div className="flex flex-col mt-10">
          ...
          <div className="flex">
            ...
            <div className="w-3/4">
              ...
              <p>구매 전환율, 브랜드 인식, 검색 엔진 등등 성능이 유저 경험에 많은 영향을 끼친다고 생각하고 개발합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col mt-12">
          ...
          <p>
            · MongoDB를 통한 페이지네이션, dynamic import 등을 사용하여 초기 로딩 속도 <span className="font-bold">0.76s → 0.15s 개선</span>
          </p>
          <p>
