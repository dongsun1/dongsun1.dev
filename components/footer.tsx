    ...
    <footer className="container text-gray-600 body-font mx-auto mt-auto w-full">
      <div className="container p-5 mx-auto flex items-center sm:flex-row flex-col mt-6 border-t">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <Link href="https://www.linkedin.com/in/%EB%8F%99%EC%84%A0-%EA%B9%80-5197ba219/" className="ml-3 flex items-centers bg-parent">
            <Image src={LinkedIn} alt="링크드인" width={20} height={20} />
          </Link>
